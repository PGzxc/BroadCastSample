...
public class MainActivity extends AppCompatActivity {
    public static final String ACTION = "com.example.broadcastsample.noti";
...
//        calendar.set(Calendar.MINUTE, calendar.get(Calendar.MINUTE) + 2);
        ...
        notificationIntent.setPackage("com.example.broadcastsample"); //in API 26, it must be explicit now.
